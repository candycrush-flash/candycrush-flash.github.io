...
window.languages = {
	...
	zh: {
		...
		title: '糖果传奇',
		ui: {
			UNLOCK_LEVEL_PROMPT: '解锁到第几关？（最高 2825）此操作不可撤销。',
			CHARGE_LIVES_PROMPT: '要填满所有生命吗？',
	...
	ja: {
		...
		title: 'キャンディークラッシュ',
		ui: {
			UNLOCK_LEVEL_PROMPT: 'どこまでレベルを解放しますか？ (1-2825) この操作は元に戻せません。',
			CHARGE_LIVES_PROMPT: 'ライフをすべて回復しますか？',
	...
	ru: {
		...
		ui: {
			...
			CHARGE_LIVES_PROMPT: 'Зарядить все жизни?',
			...
			NEW_NAME_PROMPT: 'Введите новое имя.',
	...
	es: {
		...
		title: 'Candy Crush Saga',
		ui: {
			UNLOCK_LEVEL_PROMPT: '¿Hasta qué nivel quieres desbloquear? (1-2825) Esta acción es irreversible.',
	...
	it: {
		...
		title: 'Candy Crush Saga',
		ui: {
			UNLOCK_LEVEL_PROMPT: 'Fino a quale livello vuoi sbloccare? (max 2825) Questa azione è irreversibile.',
			CHARGE_LIVES_PROMPT: 'Vuoi ricaricare tutte le vite?',
			EXTEND_LIVES_PROMPT: 'Inserisci il numero massimo di vite.',
			ENTER_PROFILE_NAME: 'Inserisci il nome del profilo',
			NAME_ALREADY_EXISTS: 'Questo nome esiste già.',
			NEW_NAME_PROMPT: 'Inserisci il nuovo nome',
			PROFILE_DATA_PROMPT: 'Inserisci i dati del profilo',
			INVALID_DATA: 'Dati non validi',
			IMPORT_ALREADY_EXISTS: 'Questo nome esiste già. Inserisci un nuovo nome o lascia vuoto per sovrascrivere.',
			PROFILE_NOT_FOUND: 'Profilo non trovato.',
			COPY_PROFILE_DATA: 'Copia i dati esportati',
			BOOSTER_LIST: 'Inserisci il numero del booster desiderato: \n1. UFO\n2. Pennello a strisce\n3. Troll della gomma\n4. Denti dolci\n5. Jolly\n6. Caramelle a strisce e avvolte\n7. Raffredda-bomba\n8. Scambio gratuito\n9. Ruota di cocco\n10. Pesce gelatina\n11. Martello lecca-lecca\n12. Mosse extra\n13. Bomba colore\n14. Tempo extra',
			BOOSTER_AMOUNT_PROMPT: 'Quanti ne desideri? (Inserisci un numero negativo per rimuoverli)',
			GOLDBAR_AMOUNT_PROMPT: 'Inserisci il numero di lingotti d’oro da aggiungere (numero negativo per diminuirli)',
			SWITCH_PROFILES: 'Cambia profilo',
			MANAGE_PROFILES: 'Gestisci profili',
			NEW_PROFILE: 'Crea nuovo profilo',
			DELETE_PROFILE: 'Elimina profilo attuale',
			RENAME_PROFILE: 'Rinomina profilo',
			IMPORT_PROFILE: 'Importa profilo',
			EXPORT_PROFILE: 'Esporta profilo',
			GAME_TOOLS: 'Strumenti di gioco',
			UNLOCK_LEVELS: 'Sblocca livelli',
			CHARGE_LIVES: 'Ricarica vite',
			EXTEND_LIVES: 'Aumenta vite massime',
			ADD_BOOSTERS: 'Aggiungi booster',
			ADD_GOLDBARS: 'Aggiungi lingotti d’oro',
			LEVEL_EDITOR: 'Editor livelli',
			SELECT_LANGUAGE: 'Seleziona lingua',
			SELECT_VERSION: 'Seleziona versione',
			DELETE_PROFILE_CONFIRM: 'Eliminare il profilo corrente? Perderai tutti i progressi.',
			RESET_WHEEL: 'Reimposta tempo ruota',
			RESET_WHEEL_CONFIRM: 'Sei sicuro di voler reimpostare la ruota per poterla girare di nuovo ora?',
