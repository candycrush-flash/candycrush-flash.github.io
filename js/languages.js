...
window.languages = {
	...
	ko: {
		...
		ui: {
			...
			BOOSTER_LIST: '부스터의 번호를 입력하십시오\n\n1. UFO\t\t2. 줄무늬 브러쉬\t3. 버블껌 트롤\n4. 달콤한 이빨\t5. 조커\t\t6. 줄무늬 캔디와 포장 캔디\n7. 폭탄 쿨러\t8. 맘대로 바꾸기\t9. 코코넛 휠\n10. 젤리 물고기\t11. 롤리팝 해머\t12. 추가 이동 횟수\n13. 컬러 폭탄\t14. 추가 시간\t15. 시간 정지 마법\n16. 페인트 마법',
	...
	zh: {
		...
		ui: {
			...
			BOOSTER_LIST: '请输入想要的增强道具编号：\n\n1. UFO\t\t2. 条纹刷\t\t3. 泡泡糖巨魔\n4. 甜牙\t\t5. 小丑\t\t6. 条纹包装糖果\n7. 炸弹冷却器\t8. 自由切换\t9. 椰子轮\n10. 水母\t\t11. 棒棒糖锤\t12. 额外移动\n13. 彩色炸弹\t14. 额外时间\t15. 時光凍結祝福\n16. 條紋祝福',
	...
	ja: {
		...
		ui: {
			...
			BOOSTER_LIST: '欲しいブースターの番号を入力してください: \n\n1. UFO\t\t\t\t2. ストライプブラシ\n3. バブルガムトロール\t\t4. スウィートティース\n5. ジョーカー\n6. ストライプキャンディーとラッピングキャンディー\n7. ボムクーラー\t\t\t8. フリースイッチ\n9. ココナッツホイール\t\t10. ジェリーフィッシュ\n11. ロリポップハンマー\t12. エクストラムーブ\n13. カラーボム\t\t\t14. エクストラタイム\n15. フローズンタイム\t\t16. ストライプキャンディー',
			...
			THEME_DEFAULT: 'デフォルト',
			THEME_CLASSIC: 'クラシック',
			THEME_HALLOWEEN: 'ハロウィン',
			THEME_HALLOWEEN2015: 'ハロウィン 2015',
			THEME_XMAS: 'クリスマス',
		}
	},
	ru: {
		...
		title: 'Candy Crush Saga',
		ui: {
			UNLOCK_LEVEL_PROMPT: 'Разблокировать уровни до какого уровня? (1-2825) Это действие необратимо.',
			...
			BOOSTER_LIST: 'Введите номер нужного усилителя: \n\n1. НЛО\t\t\t\t\t\t2. Полосатая щётка\n3. Тролль из жвачки\t\t\t4. Сладкоежка\n5. Джокер\t\t\t\t\t6. Конфеты в полоску и обёртке\n7. Охладитель бомб\t\t\t8. Свободный переключатель\n9. Кокосовое колесо\t\t\t10. Желейная рыбка\n11. Молоток для леденцов\t\t12. Дополнительные ходы\n13. Цветная бомба\t\t\t\t14. Дополнительное время\n15. Талисман заморозки времени\t16. Талисман «Полосы»',
			...
			THEME_HALLOWEEN: 'Хэллоуин',
			THEME_HALLOWEEN2015: 'Хэллоуин 2015',
			THEME_XMAS: 'Рождество',
		}
	},
	es: {
		display: 'Español',
		...
		ui: {
			...
			BOOSTER_LIST: 'Introduce el potenciador que quieras en número: \n\n1. OVNI\t\t\t2. Pincel de rayas\t3. Troll chicle\n4. Dientes dulces\t5. Comodín\n6. Caramelos rayados y envueltos\t\t7. Antipimienta\n8. Cambio gratuito\t9. Rueda de coco\t10. Medusa\n11. Martillo de piruleta\t12. Movimientos extra\t13. Bomba de color\n14. Tiempo extra\t15. Amuleto de congelación de tiempo\n16. Amuleto de rayas',
	...
	it: {
		...
		ui: {
			...
			BOOSTER_LIST: 'Inserisci il numero del booster desiderato: \n\n1. UFO\t\t\t2. Pennello a strisce\t\t3. Troll della gomma\n4. Denti dolci\t\t5. Jolly\t\t\t\t6. Caramelle a strisce e avvolte\n7. Raffredda-bomba\t8. Scambio gratuito\t\t9. Ruota di cocco\n10. Pesce gelatina\t11. Martello lecca-lecca\t12. Mosse extra\n13. Bomba colore\t14. Tempo extra\t\t\t15. Amuleto del tempo congelato\n16. Amuleto delle strisce',
